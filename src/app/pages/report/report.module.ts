...
@NgModule({
  declarations: [RetrievalreportComponent,RefillingreportComponent,OutreportComponent,DumpreportComponent, PickupRequestReportComponent, InventoryReportComponent, DisInventoryReportComponent,InventoryUploadReportComponent,ItemstatusreportComponent],
  imports: [
    CommonModule,
