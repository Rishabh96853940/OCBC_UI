...
@NgModule({
  declarations: [DepartmentComponent,BranchMappingComponent,BranchComponent,EmailNotificationComponent, CrownMasterComponent, CrownMappingComponent, ApprovalComponent, WarehouseComponent],
  imports: [
    CommonModule,
